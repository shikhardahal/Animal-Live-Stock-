   ...
   <div class="signin">
    ...
    <div class="content">
     ...
     <div class="form" id="form">
      ...
      <div class="links"> <a href="#"> </a> <a href="{{ route('signup') }}">Signup</a>
...
<script>
  $(document).ready(function () {
    $("#submit").click(function () {
      ...
      $.ajax({
        url: "{{ route('login_admin_dashboard') }}", // Replace with the actual route to your controller
        type: "POST",
        data: {
          username: username,
          password: password,
          _token: _token, // Send CSRF token with the request
        },
